...
let str65 = 'aaa [2] bbb [3] ccc [12] ddd';
//find числа, стоящие в скобках и увеличьте их в два раза. То есть из нашей строки должна получится следующая:
//'aaa [4] bbb [6] ccc [24] ddd'
console.log(str65.replace(/(\d+)/g, function (match) {
    return match * 2;
}));
let str66 = '123 456 789';
//find все числа и переверните их цифры в обратном порядке. То есть из нашей строки должна получится следующая:
// '321 654 987'
console.log(str66.replace(/\d+/g, match => match.split('').reverse().join('')));
let str67 = '31.12.2025 30.11.2024 29.10.2023';
//find  все даты и преобразуйте их в другой формат так, чтобы получилась следующая строка:
// '2025-12-31 2024-11-30 2023-10-29'
console.log(str67.replace(/\d+\.\d+\.\d+/g, function (match) {
    return match.split('.').reverse().join('-');
}));

///////////////////////////////////////////////////////////////
//Метод search в регулярных выражениях JavaScript
let str68 = '1 23 456 789';
//find Найдите позицию первого числа, состоящего из трех цифр.
console.log(str68.search(/\d{3}/));

////////////////////////////////////////////////////////////////
//Метод split в регулярных выражениях JavaScript
let str69 = 'a-b+c-d+e';
console.log(str69.split(/[-+]/));
let str70 = '2025-12-31 12:59:59';
